    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.html">
          ...
          <span>eCommerce Dashboard</span></a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePagesCategory" aria-expanded="true" aria-controls="collapsePagesCategory">
          <i class="fas fa-fw fa-folder"></i>
          <span> Category </span>
        </a>
        <div id="collapsePagesCategory" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePagesProduct" aria-expanded="true" aria-controls="collapsePagesBlogPost">
          <i class="fas fa-fw fa-folder"></i>
          <span> Product </span>
        </a>
        <div id="collapsePagesProduct" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{URL::to('get-product-insert-form')}}"> Insert New Product </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePagesSlider" aria-expanded="true" aria-controls="collapsePagesBlogPost">
          <i class="fas fa-fw fa-folder"></i>
          <span> Slider </span>
        </a>
        <div id="collapsePagesSlider" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{URL::to('get-slider-form')}}"> Create Slider </a>
            <a class="collapse-item" href="{{URL::to('all-sliders')}}"> All Sliders</a>
